...
public class OrderFotoUtil {
    ...
    private static List<com.example.cetakfotoku2.KeranjangBelanjaListener> kbListeners;
    ...
    public static void addKbListener(com.example.cetakfotoku2.KeranjangBelanjaListener listener){
    ...
    private static void updateKeranjangBelanja(){
        ...
        for (com.example.cetakfotoku2.KeranjangBelanjaListener listener:kbListeners){
