...
public class OrderFoto {
    private com.example.cetakfotoku2.KatalogFoto katalogFoto;
    private String ukuran;
    private int numOrder;
    private double hargaSubtotal;

    public OrderFoto(com.example.cetakfotoku2.KatalogFoto _katalogFoto, int _numOrder, String _ukuran,
    ...
    public com.example.cetakfotoku2.KatalogFoto getKatalogFoto(){
        return katalogFoto;
    }
